            ...
            <div class="row align-items-center">
              <div class="col-md">
                ...
                <p class="lead mb-5 probootstrap-animate">
                  <a href="#" role="button" class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">Read More</a> 
                </p>
              </div> 
        ...
        <section class="probootstrap_section" id="section-city-guides">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6 probootstrap-animate mb-3">
                <a href="#" class="probootstrap-thumbnail">
                  <img src="/assets/images/img_4.jpg" alt="Free Template by Techstring IT" class="img-fluid">
                  <h3>Japan</h3>
                </a>
              </div>
            </div>
